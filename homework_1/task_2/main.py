...
print("Привет! Эта программа находит количество журавликов, которые сделал каждый ребёнок.")
print()

totalCranes = int(input("Введите чётное количество сделанных журавликов: ")) # Из примеров задачи я понял что число журавликов должно быть именно чётным
resultPete = 0
resultKate = 0
resultSerj = 0
print()
